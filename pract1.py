...
class zal(room):
    """Kласс комнат для учебы, содержащий допустимость прохода в него, имя, номер
...
class study_room(room):
    """Класс учительских, содержащий допустимость прохода в него, имя, номер
...
class uchitelskaia(room):
    """Класс кабинетов директора, содержащий допустимость прохода в него, имя, номер
...
class directors_room(room):
    """Класс залов, содержащий допустимость прохода в него, имя, номер
...
"""Класс родителей, отвечает за их возможность посещать комнаты
...
class Student(people):
    """Класс учеников, отвечает за их возможность посещать комнаты
...
class Teacher(people):
    """Класс преподавателей, отвечает за их возможность посещать комнаты
...
class Director(people):
    """Класс директоров, отвечает за их возможность посещать комнаты
